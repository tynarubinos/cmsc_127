...
def add_product():
    if request.method == "POST":
        ...
        cursor.execute("INSERT INTO product (product_code, category_id, name, date_acquired, expiration_date, quantity, cost, storage_location, id) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)", 
                       (product_code, category_id, name, date_acquired, 
                        expiration_date, quantity, cost, storage_location, id))
        db.commit()
...
def edit_product(product_code):
    if request.method == "POST":
        ...
        cursor.execute("UPDATE product SET product_code=%s, category_id=%s, name=%s, date_acquired=%s, expiration_date=%s, quantity=%s, cost=%s, storage_location=%s, id=%s WHERE product_code=%s", 
                       (product_code, category_id, name, date_acquired, expiration_date, quantity, cost, storage_location, id, product_code))
        db.commit()
